...
- **User-Friendly UI**: Simple interface with buttons for connect/disconnect, lock, unlock, wake, send password, clipboard sync, and password change.
...
- **`app/src/main/java/io/github/ktauchathuranga/utils/MainActivity.java`**:
    - Main logic for Bluetooth HID, UI handling, encrypted password management, and clipboard sync.
- **`app/src/main/res/layout/activity_main.xml`**:
    - UI layout with buttons for connect, lock, unlock, wake, send password, clipboard sync, and password change.
- **`app/build.gradle`**:
